        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8  xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    <img src="{{asset('img/logonew.png')}}" alt="" height="200px" width="300px">
                    ...
                    <div class="intro-x mt-2">
                        ...
                        >
                        @csrf
                            <input id="userName" type="text" class="intro-x login__input form-control py-3 px-4 block" placeholder="Username" wire:model="username">
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        ...
                        <a href="{{route('login.register')}}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</a>
                    </div>
